...
class irex_lite_breadcrumb_class {

    var $opts;



    function irex_lite_custom_breadcrumb() {
        ...
        echo '<section class="cont_nav"><div class="cont_nav_inner"><p><a href="' . esc_url(home_url('/')) . '">' . __('Home', 'irex-lite') . '</a>';
        ...
        $output = $this->irex_lite_simple_breadcrumb_case($post);
    ...
    function irex_lite_simple_breadcrumb_case($der_post) {
        ...
        if (is_page()) {
            ...
            if ($der_post->post_parent) {
                ...
                $this->irex_lite_simple_breadcrumb_case($my_query);
        ...
        if (is_author()) {
            ...
            return __('Author', 'irex-lite') . ': ' . $curauth->nickname;
        ...
        if (is_tag()) {
            ...
            return __('Tag', 'irex-lite') . ': ' . single_tag_title('', false);
...
$irex_breadcumb = new irex_lite_breadcrumb_class();
